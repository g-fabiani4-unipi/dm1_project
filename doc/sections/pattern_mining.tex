...
\end{table}
The performance of our simple rule-based classifier on the test set is reported in Table \ref{tab:class_report_rules}. It achieved an accuracy of 60\% and a macro F1 score of 67.5\%, outperforming our baseline model, a stratified dummy classifier trained on the training set, across all metrics for all classes (accuracy: 0.25, macro F1: 0.20).
\begin{table}
    \centering
    \small
    \setlength{\tabcolsep}{4pt}  % Reduces column padding
