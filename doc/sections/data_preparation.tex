...
\begin{table*}[h]
    ...
    \hline
    \textbf{Feature} & \textbf{Description} & \textbf{Type} & \textbf{dtype} \\ \hline
...
The stratified barplot in Figure \ref{fig:stratified_barplot_genres_titleTypes.png} shows that there is some variation in the frequency of different genres with respect to \textit{titleType}. We decided to fill the 382 missing values for \textit{genres} with the most frequent list of genres given the title type of the record (cf. Table \ref{tab:top_genre_median_runtime}).
\begin{figure}
...
\begin{table}[h]
    ...
    \renewcommand{\arraystretch}{0.9}
    \begin{tabular}{|l|p{3.9cm}|p{1.2cm}|}
    \hline
    \textbf{titleType} & \textbf{top genre} & \textbf{mdn\newline runtime} \\ \hline
    movie          & {[}Drama{]}                     & 90          \\ \hline
    short          & {[}Short{]}                   & 12          \\ \hline
    tvEpisode      & {[}Comedy{]}                    & 40          \\ \hline
    tvMiniSeries   & {[}Drama{]}                     & 60          \\ \hline
    tvMovie        & {[}Drama{]}                     & 86          \\ \hline
    tvSeries       & {[}Comedy{]}                    & 31          \\ \hline
    tvShort        & {[}Animation, Family, Short{]}  & 10          \\ \hline
    tvSpecial      & {[}Comedy{]}                    & 60          \\ \hline
    video          & {[}Adult{]}                     & 76          \\ \hline
    videoGame      & {[}Action, Adventure, Fantasy{]}& 28          \\ \hline
    \end{tabular}
...
\begin{table}[h]
    ...
    \begin{tabular}{c|ccc}
        \hline
        \textbf{Value} & \textbf{awAndNoms} & \textbf{hasVids} & \textbf{moreCofOr} \\ \hline
        \textbf{False} & 13692 & 14821 & 15285 \\ \hline
        \textbf{True}  & 2739  & 1610  & 1146  \\ \hline
    \end{tabular}
