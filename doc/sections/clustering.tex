...
Boxplots for the remaining variables also confirm the insights that were previously discussed. For \textit{runtimeMinutes}, Clusters 4 and 6 have the lowest median, at 12 minutes, as well as a short box, indicating low variability. Cluster 4 follows at 40 minutes, coherently with the length of a tvEpisode.
\begin{figure}
